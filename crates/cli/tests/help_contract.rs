...
fn top_level_command_help_contract() {
    let cases = [
        ...
        HelpCase {
            args: &["admin", "bucket"],
            usage: "Usage: rc admin bucket [OPTIONS] <COMMAND>",
            expected_tokens: &["migration"],
        },
        HelpCase {
            args: &["admin", "bucket", "migration"],
            usage: "Usage: rc admin bucket migration [OPTIONS] <COMMAND>",
            expected_tokens: &["set", "get", "rm", "status", "backfill"],
        },
        HelpCase {
            args: &["admin", "bucket", "migration", "set"],
            usage: "Usage: rc admin bucket migration set [OPTIONS] --provider <PROVIDER> --region <R> --source-bucket <B> <TARGET>",
            expected_tokens: &[
                "--endpoint",
                "--prefix",
                "--source-prefix",
        ...
        HelpCase {
            args: &["admin", "bucket", "migration", "backfill"],
            usage: "Usage: rc admin bucket migration backfill [OPTIONS] <COMMAND>",
            expected_tokens: &["start", "cancel", "status"],
        },
        HelpCase {
            args: &["admin", "bucket", "migration", "backfill", "start"],
            usage: "Usage: rc admin bucket migration backfill start [OPTIONS] <TARGET>",
            expected_tokens: &["--prefix", "--skip-existing", "--dry-run"],
        },
        HelpCase {
            args: &["bucket"],
