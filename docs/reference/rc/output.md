...
| [`output_v3.json`](../../../schemas/output_v3.json) | New capability, version, lock, multipart, watch, health, usage, metrics, admin-operation, and replication families | Contract for new implementations |
